    ...
    <div class="container" data-aos="fade-down" style="font-family: Poppins, sans-serif;margin-bottom:2%">
        ...
        <div class="container" style="border-style:solid;border-width:1px;border-radius:10px">
            <div class="row" style="background: #027673;height:5%;text-align:center;border-radius:10px">
                <h5 id="h4" style="color:#fff;font-weight:bold"><br>Competency Area: Managing effective workplace in a Digital Government setting<br></h5>
            </div>
            <div class="row" style="text-align:center">
                <h5 id="h4" style="color: rgb(0,0,0);font-weight:bold"><br>Create an enabling environment that promotes collaboration, productivity and build trust among teams<br><br></h5>
            </div>
        </div>
        <div class="container" data-aos="fade-down" data-aos-duration="1000" style="text-align:left;margin-top: 2%;border-radius: 10px;border: 2px solid #5f2b84;">
            <div class="row">
                ...
                <div class="col-11">
                    <h5 id="h4" style="color: #1f2471;margin-top:2%;margin-left:-4%">Why should a Chief Digital Information Officer (CDIO) be attentive to impediments in the delivery of digital government services?</h5>
                </div>
            </div>
            ...
            <div class="row" style="margin-top: 1%">
                ...
                <div class="col-11" style="text-align:left">
                    <label for="mgt8_1" style="color: var(--bs-emphasis-color);"><h5 id="h4">a) To overlook problems and issues</h5></label>
                </div>
            </div>
            ...
            <div class="row" style="margin-top: 1%">
                ...
                <div class="col-11" style="text-align:left">
                    <label for="mgt8_2" style="color: var(--bs-emphasis-color);"><h5 id="h4">b) To maintain a rigid and unchanging approach</h5></label>
                </div>
            </div>
            ...
            <div class="row" style="margin-top: 1%">
                <div class="col-1" style="text-align:right">
                    <input type="radio" name="mgt8" id="mgt8_4" value="0">
                </div>
                <div class="col-11" style="text-align:left">
                    <label for="mgt8_4" style="color: var(--bs-emphasis-color);"><h5 id="h4">d) To discourage problem-solving efforts</h5></label>
                </div>
            </div>
            <div class="row">
                <div class="col-1" style="margin-top:2%">
                ...
                <div class="col-11">
                    <h5 id="h4" style="color: #1f2471;margin-top:2%;margin-left:-4%">When implementing digital services, there can be many challenges related to internal risk aversion and user adoption, but these challenges are easily overcome and quickly replaced by benefits, which include: (Select the incorrect answer)</h5>
                </div>
            </div>

            <div class="row" style="margin-top: 1%">
                <div class="col-1" style="text-align:right">
                    <input type="radio" name="mgt9" id="mgt9_1" value="0">
                </div>
                <div class="col-11" style="text-align:left">
                    <label for="mgt9_1" style="font-family: Poppins, sans-serif;color: var(--bs-emphasis-color);"><h5 id="h4">a) Better online user experiences for citizens.</h5></label>
                </div>
            </div>
            ...
            <div class="row" style="margin-top: 1%">
                ...
                <div class="col-11" style="text-align:left">
                    <label for="mgt9_2" style="color: var(--bs-emphasis-color);"><h5 id="h4">b) Increased public participation.</h5></label>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-11">
                    <h5 id="h4" style="color: #1f2471;margin-top:2%;margin-left:-4%">Why is creating an open collaborative work environment important for a Chief Digital Information Officer (CDIO)?</h5>
                </div>
            </div>
            ...
            <div class="row" style="margin-top: 1%">
                ...
                <div class="col-11" style="text-align:left">
                    <label for="mgt10_1" style="color: var(--bs-emphasis-color);"><h5 id="h4">a) To limit communication among team members</h5></label>
                </div>
            </div>

            <div class="row" style="margin-top: 1%">
                <div class="col-1" style="text-align:right">
                    <input type="radio" name="mgt10" id="mgt10_2" value="0">
                </div>
                <div class="col-11" style="text-align:left">
                    <label for="mgt10_2" style="color: var(--bs-emphasis-color);"><h5 id="h4">b) To foster a closed and competitive atmosphere</h5></label>
                </div>
            </div>
