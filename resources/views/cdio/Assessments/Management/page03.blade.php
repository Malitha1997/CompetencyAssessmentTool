        ...
        <div class="row">
            ...
            <div class="row" style="margin-top: 1%">
                <div class="col-1" style="text-align:right">
                    <input type="radio" name="mgt18" id="mgt18_1" value="7">
                </div>
            ...
            <div class="row" style="margin-top: 1%">
                <div class="col-1" style="text-align:right">
                    <input type="radio" name="mgt18" id="mgt18_3" value="0">
                </div>
                <div class="col-11" style="text-align:left">
            ...
            <div class="row" style="margin-top: 1%">
                <div class="col-1" style="text-align:right">
                    <input type="radio" name="mgt19" id="mgt19_4" value="7">
                </div>
                <div class="col-11" style="text-align:left">
            ...
            <div class="row" style="margin-top: 1%">
                <div class="col-1" style="text-align:right">
                    <input type="radio" name="mgt5" id="mgt5_1" value="7">
                </div>
                <div class="col-11" style="text-align:left">
            ...
            <div class="row" style="margin-top: 1%">
                <div class="col-1" style="text-align:right">
                    <input type="radio" name="mgt5" id="mgt5_4" value="0">
                </div>
                <div class="col-11" style="text-align:left">
            ...
            <div class="row" style="margin-top: 1%">
                <div class="col-1" style="text-align:right">
                    <input type="radio" name="mgt6" id="mgt6_1" value="7">
                </div>
                <div class="col-11" style="text-align:left">
            ...
            <div class="row" style="margin-top: 1%">
                <div class="col-1" style="text-align:right">
                    <input type="radio" name="mgt7" id="mgt7_1" value="7">
                </div>
                <div class="col-11" style="text-align:left">
