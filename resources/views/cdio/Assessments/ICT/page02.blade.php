...
<div class="container" data-aos="fade-down" style="font-family: Poppins, sans-serif;margin-bottom:2%">
    ...
    <div class="container" data-aos="fade-down" data-aos-duration="1000" style="text-align:left;margin-top: 2%;border-radius: 10px;border: 2px solid #5f2b84;">
        ...
        <div class="row" style="margin-top:1%">
            <div class="col-1" style="text-align:right">
                <input type="radio" name="ict7" id="ict7_2" style="font-family: Poppins, sans-serif;color: var(--bs-emphasis-color);" value="4">
            </div>
            <div class="col-11" style="text-align:left">
        ...
        <div class="row" style="margin-top:1%">
            <div class="col-1" style="text-align:right">
                <input type="radio" name="ict8" id="ict8_2" style="font-family: Poppins, sans-serif;color: var(--bs-emphasis-color);" value="4">
            </div>
            <div class="col-11" style="text-align:left">
        ...
        <div class="row" style="margin-top:1%">
            <div class="col-1" style="text-align:right">
                <input type="radio" name="ict8" id="ict8_3" style="font-family: Poppins, sans-serif;color: var(--bs-emphasis-color);" value="0">
            </div>  
            <div class="col-11" style="text-align:left">
        ...
        <div class="row" style="margin-top:1%">
            <div class="col-1" style="text-align:right">
                <input type="radio" name="ict9" id="ict9_2" style="font-family: Poppins, sans-serif;color: var(--bs-emphasis-color);" value="4">
            </div>
            <div class="col-11" style="text-align:left">
        ...
        <div class="row" style="margin-top:1%">
            <div class="col-1" style="text-align:right">
                <input type="radio" name="ict10" id="ict10_4" value="4">
            </div>
            <div class="col-11" style="text-align:left">
        ...
        <div class="row" style="margin-top:1%">
            <div class="col-1" style="text-align:right">
                <input type="radio" name="ict11" id="ict11_4" value="4">
            </div>
            <div class="col-11" style="text-align:left">
        ...
        <div class="row" style="margin-top:1%">
            <div class="col-1" style="text-align:right">
                <input type="radio" name="ict12" id="ict12_1" value="4">
            </div>
            <div class="col-11" style="text-align:left">
        ...
        <div class="row" style="margin-top:1%">
            <div class="col-1" style="text-align:right">
                <input type="radio" name="ict12" id="ict12_3" value="0">
            </div>  
            <div class="col-11" style="text-align:left">
