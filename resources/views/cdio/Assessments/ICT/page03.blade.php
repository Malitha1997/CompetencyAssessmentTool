...
<div class="container" data-aos="fade-down" style="font-family: Poppins, sans-serif;margin-bottom:2%">
    ...
    <div class="container" data-aos="fade-down" data-aos-duration="1000" style="text-align:left;margin-top: 2%;border-radius: 10px;border: 2px solid #5f2b84;">
        ...
        <div class="row" style="margin-top:1%">
            <div class="col-1" style="text-align:right">
                <input type="radio" name="ict13" id="ict13_2" style="font-family: Poppins, sans-serif;color: var(--bs-emphasis-color);" value="4">
            </div>
            <div class="col-11" style="text-align:left">
        ...
        <div class="row" style="margin-top:1%">
            <div class="col-1" style="text-align:right">
                <input type="radio" name="ict14" id="ict14_2" style="font-family: Poppins, sans-serif;color: var(--bs-emphasis-color);" value="4">
            </div>
            <div class="col-11" style="text-align:left">
        ...
        <div class="row" style="margin-top:1%">
            <div class="col-1" style="text-align:right">
                <input type="radio" name="ict14" id="ict14_3" style="font-family: Poppins, sans-serif;color: var(--bs-emphasis-color);" value="0">
            </div>  
            <div class="col-11" style="text-align:left">
        ...
        <div class="row" style="margin-top:1%">
            <div class="col-1" style="text-align:right">
                <input type="radio" name="ict15" id="ict15_2" style="font-family: Poppins, sans-serif;color: var(--bs-emphasis-color);" value="4">
            </div>
            <div class="col-11" style="text-align:left">
        ...
        <div class="row" style="margin-top:1%">
            <div class="col-1" style="text-align:right">
                <input type="radio" name="ict18" id="ict18_1" value="4">
            </div>
            <div class="col-11" style="text-align:left">
        ...
        <div class="row" style="margin-top:1%">
            <div class="col-1" style="text-align:right">
                <input type="radio" name="ict19" id="ict19_1" value="4">
            </div>
            <div class="col-11" style="text-align:left">
        ...
        <div class="row" style="margin-top:1%">
            <div class="col-1" style="text-align:right">
                <input type="radio" name="ict20" id="ict20_1" value="4">
            </div>
            <div class="col-11" style="text-align:left">
        ...
        <div class="row" style="margin-top:1%">
            <div class="col-1" style="text-align:right">
                <input type="radio" name="ict20" id="ict20_3" value="0">
            </div>  
            <div class="col-11" style="text-align:left">
