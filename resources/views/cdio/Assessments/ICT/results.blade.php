            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="row" style="margin-top:10%">
                        <a class="btn btn-primary" type="button" href="" style="margin-left:20%;background: linear-gradient(to bottom right, #F44567 0%, #F97B5F 49%);width:60%;border-style: none;"><h4 id="h4">Download</h4></a>
                    </div>
