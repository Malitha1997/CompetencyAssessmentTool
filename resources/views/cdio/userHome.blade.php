            ...
            <div class="row">
                ...
                <div id="div2" class="col-lg-4 col-sm-4" style="background: linear-gradient(to top right, #660066 56%, #FF6699 100%);">
                    ...
                    <div class="row" style="text-align:center">  
                        <a class="btn btn-primary" id="layerButton" href="{{route('cdioMain')}}" type="button" style="margin-left:30%;margin-top:10%;text-align:center;width:40%;background: linear-gradient(to bottom right, #F44567 0%, #F97B5F 49%);border-width: 0px;font-family: Poppins, sans-serif;"><h5>Assessments</h5></a>
                    </div>
                </div>
            </div>
        </div>
