    ...
    <div class="container align-content-center align-self-center" style="width: 1358px;height: 600px;margin-top: 10px;">
        ...
        <div data-aos="fade-down" data-aos-duration="1000" style="width: 1282px;height: 900px;margin-top: 80px;border-radius: 10px;border: 2px solid #5f2b84;padding-left: 0px;margin-left: 6px;">
            <div class="row" style="margin-top: 20px;">
                <div class="col" style="margin-left: 40px;"><span style="color: #1f2471;font-family: Poppins, sans-serif;font-size: 20px;margin-left: 100px;"><br>5) Which of the following is not recommended to overcome Digital Government Service Delivery failures? (ඩිජිටල් රාජ්‍ය සේවා බෙදා හැරීමේ අසාර්ථක වීම් මඟහරවා ගැනීම සඳහා පහත සඳහන් දේවලින් නිර්දේශ නොකරන්නේ කුමක්ද?)</span></div>
            </div>
                                    ...
                                    <div class="row d-flex flex-column" style="text-align: center;">
                                        <div class="col" style="margin-top: 20px;margin-bottom: 10px;text-align: left;">
                                            <div class="row" style="margin-bottom: 20px;">
                                                <div class="col" style="margin-top: 10px;"><input type="radio" name="mgt5" id="mgt5_1" style="margin-left:50px;width:15px;height:15px;margin-right: 10px;" value="0"><label class="form-label" for="mgt5_1" style="font-family: Poppins, sans-serif;font-size: 20px;color: var(--bs-emphasis-color);margin-left: 20px;margin-top: 0px;width: 1100px;">a) Preventive actions by educating the users in advance (පරිශීලකයින් කල්තියා දැනුවත් කිරීමෙන් වැළැක්වීමේ ක්‍රියාමාර්ග&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;ගැනීම )</label></div>
                                            </div>
                                            <div class="row" style="margin-bottom: 20px;">
                                                <div class="col"><input type="radio" name="mgt5" id="mgt5_2" style="margin-left:50px;width:15px;height:15px;margin-right: 10px;" value="0"><label class="form-label" for="mgt5_2" style="font-family: Poppins, sans-serif;font-size: 20px;color: var(--bs-emphasis-color);margin-left: 20px;margin-top: -28px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; b) Assistive actions to act fast to overcome the situation when it occurs ( තත්ත්වය ඇති වූ විට එය ජය ගැනීම සඳහා වේගයෙන්&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; ක්‍රියා කිරීමට උපකාරක ක්‍රියාමාර්ග ගැනීම)</label></div>
                                            </div>
                                            <div class="row" style="margin-bottom: 20px;">
                                                <div class="col"><input type="radio" name="mgt5" id="mgt5_3" style="margin-left:50px;width:15px;height:15px;margin-right: 10px;" value="0"><label class="form-label" for="mgt5_3" style="font-family: Poppins, sans-serif;font-size: 20px;color: var(--bs-emphasis-color);margin-left: 20px;margin-top: -28px;">c) Taking actions after the incident/ damage(සිද්ධිය/හානියෙන් පසු පියවර ගැනීම)</label></div>
                                            </div>
                                            <div class="row" style="margin-bottom: 20px;">
                                                <div class="col"><input type="radio" name="mgt5" id="mgt5_4" style="margin-left:50px;width:15px;height:15px;margin-right: 10px;" value="6"><label class="form-label" for="mgt5_4" style="font-family: Poppins, sans-serif;font-size: 20px;color: var(--bs-emphasis-color);margin-left: 20px;margin-top: -28px;">d) Ignore the service failure (සේවා අසාර්ථකත්වය නොසලකා හැරීම)</label></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
