            ...
            <div class="row">
                ...
                <div style="width :450.3px;background: url(&quot;{{ asset('img/Screenshot (560) 1(2).png') }}&quot;);">
                    ...
                    <div class="row" style="margin-top: 90px;">
                        ...
                        @if($layer=='middle')
                            <a class="btn btn-primary" href="/middlelayer" type="button" style="width: 266px;height: 55px;background: url(&quot;{{ asset('img/Screenshot (561) 5.png') }}&quot;);border-width: 0px;font-family: Poppins, sans-serif;font-size: 20px;"  >Assessments</a>
                        @elseif($layer=='operational')
                            <a class="btn btn-primary" href="/operationallayer" type="button" style="width: 266px;height: 55px;background: url(&quot;{{ asset('img/Screenshot (561) 5.png') }}&quot;);border-width: 0px;font-family: Poppins, sans-serif;font-size: 20px;"  >Assessments</a>
                        @elseif($layer=='top')    
                            <a class="btn btn-primary" href="/toplayer" type="button" style="width: 266px;height: 55px;background: url(&quot;{{ asset('img/Screenshot (561) 5.png') }}&quot;);border-width: 0px;font-family: Poppins, sans-serif;font-size: 20px;"  >Assessments</a>
                        @endif
                        </div>
