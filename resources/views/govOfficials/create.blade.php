...
<div class="container" data-aos="fade-down" data-aos-duration="1000" id="div1" style="font-family:poppins;background: linear-gradient(to top right, #660066 56%, #FF6699 100%);border-radius:10px;padding-bottom:3%;margin-bottom:2%">
    <div class="row" style="text-align:center;" >
        <h1 style="color:#fff;margin-top:2%">Register Now</h1>
    </div>
    <div class="container" style="background:#fff;border-radius:10px;width:80%:">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="row" style="margin-top:1%">
                    <h5 id="h4" style="color:#000000">Full Name</h5>
                </div>
                <div class="row">
                    <input class="form-control-lg" id="full_name" name="full_name" type="text" placeholder="Enter Full Name" style="width:80%;margin-left:10%" value="">
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="row" style="margin-top:1%">
                    <h5 id="h4" style="color:#000000">Preferred Name</h5>
                </div>
                <div class="row">
                    <input class="form-control-lg" id="preferred_name" name="preferred_name" type="text" placeholder="Enter Preferred Name" style="width:80%;margin-left:10%" value="">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="row" style="margin-top:1%">
                    <h5 id="h4" style="color:#000000">Designation</h5>
                </div>
                <div class="row">
                    <input class="form-control-lg" id="designation" name="designation" type="text" placeholder="Enter Designation" style="width:80%;margin-left:10%" value="">
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="row" style="margin-top:1%">
                    <h5 id="h4" style="color:#000000">Organization Name</h5>
                </div>
                <div class="row">
                    <input class="form-control-lg" name="gov_org_name" id="gov_org_name" type="text" placeholder="Select Organization Name" style="width:80%;margin-left:10%" value="" >
                    <input type="hidden" name="gov_org_name" id="gov_org_nameid" value="">
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="row" style="margin-top:1%">
                    <h5 id="h4" style="color:#000000">Contact Number</h5>
                </div>
                <div class="row">
                    <input class="form-control-lg" id="contact_number" name="contact_number" type="text" placeholder="Enter the Contact Number" style="width:80%;margin-left:10%" value="">
                </div>
            </div>
            <div class="col-lg-6 col-md-6">
                <div class="row" style="margin-top:1%">
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6">
                <div class="row" style="margin-top:1%">
                    <h5 id="h4" style="color:#000000">Employment Layer</h5>
                </div>
                <div class="row">
                    <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" id="employment_layer" name="employment_layer" placeholder="Select the Employment Layer" style="width:80%;margin-left:10%" data-toggle="tooltip" data-placement="bottom" value="" title='
            ...
            <div class="col-lg-6 col-md-6">
                <div class="row" style="margin-top:1%">
                    <h5 id="h4" style="color:#000000">Date of Birth</h5>
                </div>
                <div class="row">
                    <input class="form-control-lg" id="date_of_birth" name="date_of_birth" type="date" style="width:80%;margin-left:10%" value="">
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12">
                <div class="row" style="margin-top:1%">
                    <h5 id="h4" style="color:#000000">Linkedin</h5>
                </div>
                <div class="row">
                    <input class="form-control-lg" id="linkedin" name="linkedin" type="text" placeholder="Paste Here" style="width:80%;margin-left:10%" value="">
                </div>
            </div>
            <div class="col-lg-12 col-md-12">
                <div class="row" style="margin-top:1%">
                    <h5 id="h4" style="color:#000000">Facebook</h5>
                </div>
                <div class="row">
                    <input class="form-control-lg" id="facebook" name="facebook" type="text" placeholder="Paste Here" style="width:80%;margin-left:10%" value="">
                </div>
            </div>
            <div class="col-lg-12 col-md-12">
                <div class="row" style="margin-top:1%">
                    <h5 id="h4" style="color:#000000">Instagram</h5>
                </div>
                <div class="row">
                    <input class="form-control-lg" id="instagram" name="instagram" type="text" placeholder="Paste Here" style="width:80%;margin-left:10%" value="">
                </div>
        ...
        <div class="row" style="margin-top:3%;padding-bottom:3%">
            ...
            <div class="col-6" style="text-align:left">
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#update" type="button" style="background: linear-gradient(to bottom right, #F44567 0%, #F97B5F 49%);text-align: center;border-color: rgb(254,80,57);">Submit</button>
            </div>
            <input type="hidden" name="user_id" value="{{ Auth::user()->id }}">
        </div>
    </div>
...
<div class="modal fade" style="font-family:poppins" id="cancel" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <h5 style="color:#000000">Are you sure to cancel?</h5>
        </div>
...
<div class="modal fade" style="font-family:poppins" id="update" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-body">
            <h5 style="color:#000000">Are you sure to submit?</h5>
        </div>
        <div class="modal-footer">
            <button type="button" class="btn btn-danger" data-bs-dismiss="modal">No</button>
            <button class="btn btn-success" type="submit" style="font-family: Poppins;border-width:0px;">Yes</button>
            <form  action="{{ route('govofficials.store') }}" method="POST" class="d-none">
                @csrf
            </form>
        </div>
        </div>
