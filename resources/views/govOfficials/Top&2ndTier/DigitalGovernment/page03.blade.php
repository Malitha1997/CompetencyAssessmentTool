...
<section data-aos="fade-down" style="height: 750px;">
    ...
    <div class="container align-content-center align-self-center" style="width: 1358px;height: 600px;margin-top: 10px;">
        ...
        <div data-aos="fade-down" data-aos-duration="1000" style="width: 1282px;height: 1400px;margin-top: 80px;border-radius: 10px;border: 2px solid #5f2b84;padding-left: 0px;margin-left: 6px;">
            <div class="row" style="margin-top: 20px;">
                <div class="col" style="margin-left: 40px;"><span style="color: #1f2471;font-family: Poppins, sans-serif;font-size: 20px;margin-left: 100px;"><br>7) Which of the below statement is true about effective service delivery? (ඵලදායි සේවා සැපයීම සම්බන්ධයෙන් පහත සඳහන් කුමන ප්‍රකාශය සත්‍යද?)</span></div>
            </div>
            ...
            <div class="row" style="margin-top: -20px;">
                <div class="col" style="margin-left: 40px;"><span style="color: #1f2471;font-family: Poppins, sans-serif;font-size: 20px;margin-left: 100px;"><br>9) Identify the incorrect statement about measuring the success of digital government services. (ඩිජිටල් රාජ්‍ය සේවාවන්හි සාර්ථකත්වය මැනීම පිළිබඳ වැරදි ප්‍රකාශය හඳුනා ගන්න)</span></div>
            </div>
            <div class="row d-flex flex-column" style="text-align: center;">
                <div class="col">
                    <div class="row d-flex flex-column" style="text-align: center;">
            ...
            <div class="row" style="margin-top: -20px;">
                <div class="col" style="margin-left: 40px;"><span style="color: #1f2471;font-family: Poppins, sans-serif;font-size: 20px;margin-left: 100px;"><br>10) Identify the incorrect statement about measuring the success of digital government services. (ඩිජිටල් රාජ්‍ය සේවාවන්හි සාර්ථකත්වය මැනීම පිළිබඳ වැරදි ප්‍රකාශය හඳුනා ගන්න)</span></div>
            </div>
            <div class="row d-flex flex-column" style="text-align: center;">
                <div class="col">
                    <div class="row d-flex flex-column" style="text-align: center;">
                            ...
                            <div class="row d-flex flex-column" style="text-align: center;">
                                <div class="col">
                                    <div class="row d-flex flex-column" style="text-align: center;">
                                        <div class="col" style="margin-top: 20px;margin-bottom: 10px;text-align: left;">
                                            <div class="row" style="margin-bottom: 20px;">
                                                <div class="col"><input type="radio" name="dg10" id="dg10_1" style="margin-left:20px;width:15px;height:15px;margin-right: 10px;" value="0"><label class="form-label" for="dg10_1" style="font-family: Poppins, sans-serif;font-size: 20px;color: var(--bs-emphasis-color);margin-left: 20px;margin-top: 20px;width: 1100px;">a) Success of the digital tax system can be measured through the increased tax revenue (ඩිජිටල් බදු ක්‍රමයේ&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;සාර්ථකත්වය වැඩි වූ බදු ආදායම හරහා මැනිය හැක)</label></div>
                                            </div>
                                            <div class="row" style="margin-bottom: 20px;">
                                                <div class="col"><input type="radio" name="dg10" id="dg10_2" style="margin-left:20px;width:15px;height:15px;margin-right: 10px;" value="0"><label class="form-label" for="dg10_2" style="font-family: Poppins, sans-serif;font-size: 20px;color: var(--bs-emphasis-color);margin-left: 20px;margin-top: -28px;">&nbsp; &nbsp; &nbsp; &nbsp;  b) Success of the digital education system can be measured through the number of active users (ඩිජිටල් අධ්‍යාපන&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;ක්‍රමයේ සාර්ථකත්වය සක්‍රීය පරිශීලකයින් සංඛ්‍යාව හරහා මැනිය හැක)</label></div>
                                            </div>
                                            <div class="row" style="margin-bottom: 20px;">
                                                <div class="col"><input type="radio" name="dg10" id="dg10_3" style="margin-left:20px;width:15px;height:15px;margin-right: 10px;" value="0"><label class="form-label" for="dg10_3" style="font-family: Poppins, sans-serif;font-size: 20px;color: var(--bs-emphasis-color);margin-left: 20px;margin-top: -28px;">&nbsp; &nbsp; &nbsp; &nbsp; c) Success of a Digital health system can be measured through the number of people consulted in a day (ඩිජිටල්&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;සෞඛ්‍ය පද්ධතියක සාර්ථකත්වය මැනිය හැක්කේ දිනකට උපදේශන ලද පුද්ගලයින් සංඛ්‍යාව මගිනි)</label></div>
                                            </div>
                                            <div class="row" style="margin-bottom: 20px;">
                                                <div class="col"><input type="radio" name="dg10" id="dg10_4" style="margin-left:20px;width:15px;height:15px;margin-right: 10px;" value="6"><label class="form-label" for="dg10_4" style="font-family: Poppins, sans-serif;font-size: 20px;color: var(--bs-emphasis-color);margin-left: 20px;margin-top: -28px;">d) None of the above (ඉහත කිසිවක් නොවේ)</label></div>
                                            </div>
                                            <input class="form-control" type="hidden" id="govofficial_id" name="govofficial_id" value="{{Auth::user()->govofficial->id}}" readonly>
                                        </div>
                                    </div>
...
<div class="row" style="margin: 1199px 0px 0px 966px;margin-right: 0px;margin-top: 1700px;margin-left: 850px;margin-bottom:50px">
